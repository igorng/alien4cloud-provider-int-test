...
#    And I update cloudify 2 manager's url to "https://129.185.67.39:8100" with login "Superuser" and password "Superuser" for cloud with name "Cloudify 2"
    ...
    And I create a new application with name "block-storage-cfy2" and description "Block Storage with CFY 2" based on the template with name "block_storage-0.0.1-SNAPSHOT"
