...
#    And I upload a plugin from "../alien4cloud-cloudify3-provider"
    ...
    And I update cloudify 3 manager's url to the OpenStack's jenkins management server for orchestrator with name "cdfy3-openstack"
    ...
    And I save the attribute "endpoint" of the node "HostPoolService" as "pool_endpoint"
	 ...
	 And I update cloudify 3 manager's url to the OpenStack's jenkins management server for orchestrator with name "cdfy3-byon"
