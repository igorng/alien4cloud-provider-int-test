...
#    And I upload a plugin from maven artifact "alien4cloud:alien4cloud-cloudify3-provider"
    ...
    And I add the storage with id "SmallBlock1" and device "" and size 1073741824 to the cloud "Cloudify 3"
    And I add the storage with id "SmallBlock2" and device "" and size 1073741824 to the cloud "Cloudify 3"
    And I add the storage with id "SmallBlock3" and device "" and size 1073741824 to the cloud "Cloudify 3"
    And I add the storage with id "SmallBlock4" and device "" and size 1073741824 to the cloud "Cloudify 3"
