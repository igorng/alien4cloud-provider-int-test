...
#    And I upload a plugin from maven artifact "alien4cloud:alien4cloud-cloudify3-provider"
    ...
    And I create a resource of type "alien.nodes.openstack.Flavor" named "Medium" related to the location "Mount doom orchestrator"/"Thark location"
    And I update the property "id" to "3" for the resource named "Medium" related to the location "Mount doom orchestrator"/"Thark location"
    And I create a resource of type "alien.nodes.openstack.Image" named "Windows" related to the location "Mount doom orchestrator"/"Thark location"
    And I update the property "id" to "53e6ef20-a087-44d1-9bdb-5c7f4bffad5b" for the resource named "Windows" related to the location "Mount doom orchestrator"/"Thark location"
